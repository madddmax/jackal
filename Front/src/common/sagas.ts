...
export const sagaActions = {
    ...
    LOBBY_GET_LEADERBOARD: 'LOBBY_GET_LEADERBOARD',
    LOBBY_GET_NET_LEADERBOARD: 'LOBBY_GET_NET_LEADERBOARD',
    LOBBY_GET_BOT_LEADERBOARD: 'LOBBY_GET_BOT_LEADERBOARD',
    ...
    NET_GAME_USERS_ONLINE: 'NET_GAME_USERS_ONLINE',
