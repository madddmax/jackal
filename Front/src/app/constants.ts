            ...
            photos: [
                {
                    subTypeCount: 1,
                    name: 'Дарт Вейдер',
                    description: 'Командующий армией Галактической Империи, главный символ её мощи и страха. Один из ситхов. Одет в чёрный бронированный костюм и шлем с механическим дыханием. Костюм — это система жизнеобеспечения, поддерживающая его после тяжёлых ран.',
                },
                {
                    subTypeCount: 2,
                    name: 'Антон Чигур',
                    description: 'Совершенно хладнокровен, не испытывает никакого раскаяния, и встреча с ним для большинства персонажей оказывается смертельной. Чигур считает себя орудием судьбы. Участь нескольких встреченных им персонажей он решает при помощи подбрасывания монеты.',
                },
                {
                    subTypeCount: 1,
                },
                ...
                },
                {
                    subTypeCount: 1,
                    name: 'Алёна',
                    description: 'Гроза морей! Гроза Артёма!',
                },
            ],
            extension: '.jpg',
        },
